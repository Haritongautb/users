...
/* harmony import */ var _resources_resources__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../resources/resources */ "./clients/scripts/resources/resources.js");
/* harmony import */ var _verification_verification__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../verification/verification */ "./clients/scripts/verification/verification.js");
...
function requests(state) {
  var getData = document.getElementById("get-data-button"),
  ...
  formLoginInput.addEventListener("change", function (event) {
    state.name = event.target.value;
  });
  formPasswordInput.addEventListener("change", function (event) {
    state.password = event.target.value;
  });
  formIDInput.addEventListener("change", function (event) {
    state.id = event.target.value;
  });
  getData.addEventListener("click", function () {
    (0,_resources_resources__WEBPACK_IMPORTED_MODULE_8__.getDataRequest)('http://127.0.0.1/api/user/', (0,_verification_verification__WEBPACK_IMPORTED_MODULE_9__["default"])("token")).then(function (response) {
      if (response.length > 0) {
        console.log(response);
        document.body.innerHTML += response.map(function (item) {
          return item.name;
        });
      } else {
  ...
  signINButton.addEventListener("click", function (event) {
    ...
    (0,_resources_resources__WEBPACK_IMPORTED_MODULE_8__.postRequest)("http://127.0.0.1/api/login/", state, (0,_verification_verification__WEBPACK_IMPORTED_MODULE_9__["default"])("token")).then(function (response) {
      if (response.error) {
  ...
  signUPButton.addEventListener("click", function (event) {
    ...
    (0,_resources_resources__WEBPACK_IMPORTED_MODULE_8__.postRequest)("http://127.0.0.1/api/user/", state, (0,_verification_verification__WEBPACK_IMPORTED_MODULE_9__["default"])("token"));
  });
  getOneDataUser.addEventListener("click", function (event) {
    event.preventDefault();
    if (!state.id) {
      alert("напишите id пользователя");
      return;
    }
    (0,_resources_resources__WEBPACK_IMPORTED_MODULE_8__.getDataRequest)("http://127.0.0.1/api/user/".concat(state.id), (0,_verification_verification__WEBPACK_IMPORTED_MODULE_9__["default"])("token")).then(function (response) {
      console.log(response);
  ...
  deleteUserButton.addEventListener("click", function () {
    ...
    (0,_resources_resources__WEBPACK_IMPORTED_MODULE_8__.deleteUser)("http://127.0.0.1/api/user/".concat(state.id), (0,_verification_verification__WEBPACK_IMPORTED_MODULE_9__["default"])("token")).then(function (response) {
...
/***/ "./clients/scripts/resources/resources.js":
/*!************************************************!*\
  !*** ./clients/scripts/resources/resources.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "getDataRequest": () => (/* binding */ getDataRequest),
...
/* harmony import */ var _verification_verification__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ../verification/verification */ "./clients/scripts/verification/verification.js");
...
function _postRequest() {
  _postRequest = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(url, data) {
    var header,
      result,
      _args = arguments;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          header = _args.length > 2 && _args[2] !== undefined ? _args[2] : (0,_verification_verification__WEBPACK_IMPORTED_MODULE_29__["default"])("token");
          _context.next = 3;
          return fetch(url, {
            method: "POST",
...
function getDataRequest(_x3, _x4) {
  return _getDataRequest.apply(this, arguments);
}
function _getDataRequest() {
  _getDataRequest = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(url, header) {
    var result;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          if ((0,_verification_verification__WEBPACK_IMPORTED_MODULE_29__["default"])("token")) {
            _context2.next = 4;
            break;
          }
...
function _deleteUser() {
  _deleteUser = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(url, header) {
    var result;
...
/***/ "./clients/scripts/verification/verification.js":
/*!******************************************************!*\
  !*** ./clients/scripts/verification/verification.js ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  var state = {};
  (0,_modules_requests__WEBPACK_IMPORTED_MODULE_1__["default"])(state);
});
})();
